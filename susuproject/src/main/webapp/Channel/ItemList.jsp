...
String nickname = (String) session.getAttribute("nickname");
    ...
    ArrayList<ProductDTO> item_List = pdao.showItemList(nickname);
...
<% for(int i = 0 ; i<pdao.showItemList(nickname).size();i++){%>
            <div class="col-lg-3">

                <div class="card">
                    <a href="../Item/ItemDetail.jsp">
                        <img src="../img/<%= item_List.get(i).getProduct_image1() %>.jpg" class="card-img-top" alt="...">
                        <div class="card-body">
                        <p class="card-title"><%= item_List.get(i).getProduct_name() %></p>
                        <p class="card-text"><%= item_List.get(i).getProduct_price() %></p>
                        <p class="card-text">★<%= (Math.random() * (5.0 - 2.0) + 2.0) %></p>
