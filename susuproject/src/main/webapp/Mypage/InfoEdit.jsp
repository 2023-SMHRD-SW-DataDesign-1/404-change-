...
<body>
	...
	<div class="mypage_ctn">
		<span><a href="./CartList.jsp">장바구니 목록</a></span> <span><a
			href="./PayList.jsp">결제한 내역</a></span> <span id="ctn-select"><a
			href="./InfoEdit.jsp">회원정보 수정</a></span>
	...
	<div class="info-container">
		...
		<form action="">
			...
			<div class="form-group">
				<label for="nickname">닉네임</label> <input type="text" id="nick-edit"
					name="nick-edit">
			</div>
			<div class="form-group">
				<label for="password">기존 비밀번호</label> <input type="password"
					id="old-pw" name="old-pw">
			...
			<div class="form-group">
				<label for="password">변경할 비밀번호</label> <input type="password"
					id="pw-edit" name="pw-edit">
			</div>


			<div class="form-group">
				<label for="phonenum">전화번호</label> <input type="text"
					id="phone-edit" name="phone-edit">
			</div>

			<div class="form-group">
				<label for="address">집주소</label> <input type="text" id="adr-edit"
					name="adr_edit">
