...
<body>
    ...
    <div class="feed-board">
        ...
        <form action="../FeedUploadCon" method="post" enctype="multipart/form-data">
            ...
            <div class="file-container">
                ...
                <!-- 버튼 클릭시 파일 탐색기 실행 -->
                <input type="button" class="file-button" name="feedImages" value="업로드" onclick=document.all.file.click();>
                <input type="file" name="feedImages" id="file" style="display: none;" />

            </div>

            <!-- 피드 텍스트 -->
            <div class="feed-text">
                <textarea name="text" cols="93%" rows="10%" placeholder="텍스트 입력"></textarea>
            </div>
 ...
 <!--              <a href="../Seller/MychannelMain.jsp">-->
              ...
              <!--        <a href="../Channel/Notice.jsp" value="등록하기">-->
                </a>
            </div>
        </form>
