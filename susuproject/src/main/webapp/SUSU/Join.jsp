    ...
    <div class="signup-container">
        ...
        <form action="../JoinController" method="post" >
            ...
            <div class="form-group">
                ...
                <input type="radio" name="gender" value='t'  placeholder="male">남자
                <input type="radio" name="gender" value='f' placeholder="female">여자
            </div>

            <div class="form-group">
                <label for="birthday">생일</label>
                <input type="text" id="birthday" name="age" placeholder="1990-01-01" required>
            </div>

            <div class="form-group">
                <label for="phoneNum">휴대폰 번호</label>
                <input type="text" id="phoneNum" name="phone" placeholder="010-1234-5678" required>
            </div>
